...
def main():
    ...
    combined_dataset = ConcatDataset([before_dataset, after_dataset])
    ...
    for config in configs:
        ...
        model.load_state_dict(torch.load(os.path.join(root, 'vae_weights/vae_dropout_0.pt'), map_location=device))
        ...
        torch.save(best_model_state, os.path.join(root, f'vae_weights/vae_fine_tune_{config[1]}_dropout_{dropout}.pt'))
